...
fn the_schema_has_no_column_for_forbidden_content() {
    ...
    const SCHEMA: &[(&str, &str)] = &[
        ...
        ("capability_profile_entries", "capability_name"),
        ("capability_profile_entries", "capability_profile_id"),
        ("capability_profile_entries", "digest_hex"),
        ("capability_profiles", "capability_count"),
        ("capability_profiles", "capability_profile_id"),
        ("capability_profiles", "created_event_seq"),
        ("capability_profiles", "digest_hex"),
        ("delegation_policies", "allowed_role_count"),
        ("delegation_policies", "created_event_seq"),
        ("delegation_policies", "delegation_policy_id"),
        ("delegation_policies", "digest_hex"),
        ("delegation_policy_entries", "allowed_role"),
        ("delegation_policy_entries", "delegation_policy_id"),
        ("delegation_policy_entries", "digest_hex"),
        ...
        ("managed_config_artifacts", "byte_len"),
        ("managed_config_artifacts", "created_at_ms"),
        ("managed_config_artifacts", "created_event_seq"),
        ("managed_config_artifacts", "eligible_for_delete_at_ms"),
        ("managed_config_artifacts", "hook_contract_epoch"),
        ("managed_config_artifacts", "managed_config_artifact_id"),
        ("managed_config_artifacts", "media_type"),
        ("managed_config_artifacts", "retention_state"),
        ("managed_config_artifacts", "sha256_hex"),
        ("managed_config_artifacts", "storage_ref"),
        ("meta", "key"),
        ("meta", "value"),
        ("model_policies", "created_event_seq"),
        ("model_policies", "digest_hex"),
        ("model_policies", "model_policy_id"),
        ...
        ("session_edges", "child_session_id"),
        ("session_edges", "created_event_seq"),
        ("session_edges", "parent_session_id"),
        ("session_edges", "parent_turn_id"),
        ("session_edges", "relation_kind"),
        ...
        ("session_loadouts", "bound_event_seq"),
        ("session_loadouts", "digest_hex"),
        ("session_loadouts", "session_id"),
        ("session_loadouts", "session_incarnation_id"),
        ("session_loadouts", "worker_loadout_id"),
        ...
        ("worker_loadouts", "capability_profile_digest_hex"),
        ("worker_loadouts", "capability_profile_id"),
        ("worker_loadouts", "created_event_seq"),
        ("worker_loadouts", "delegation_policy_digest_hex"),
        ("worker_loadouts", "delegation_policy_id"),
        ("worker_loadouts", "digest_hex"),
        ("worker_loadouts", "hook_contract_epoch"),
        ("worker_loadouts", "managed_config_artifact_id"),
        ("worker_loadouts", "managed_config_byte_len"),
        ("worker_loadouts", "managed_config_digest_hex"),
        ("worker_loadouts", "model_policy_digest_hex"),
        ("worker_loadouts", "model_policy_id"),
        ("worker_loadouts", "resume_policy"),
        ("worker_loadouts", "role"),
        ("worker_loadouts", "runtime_kind"),
        ("worker_loadouts", "worker_kind"),
        ("worker_loadouts", "worker_loadout_id"),
    ];
